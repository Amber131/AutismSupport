    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <h3 className="text-base font-semibold text-gray-800 mb-4">קישורים מהירים</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="text-gray-600 hover:text-blue-500">אודות</Link>
              </li>
              <li>
                <Link href="/resources" className="text-gray-600 hover:text-blue-500">משאבים</Link>
              </li>
              <li>
                <Link href="/tools" className="text-gray-600 hover:text-blue-500">כלים יומיומיים</Link>
              </li>
              <li>
